                                                ...
                                                <form action="">
                                                    <div className="form-row">
                                                        <div className="form-group col-xl-12">
                                                            <label className="me-sm-2">Your Name</label>
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                <form action="">
                                                    <div className="form-row">
                                                        <div className="form-group col-xl-12">
                                                            <label className="me-sm-2">New Email</label>
                                                            <input type="email" className="form-control" placeholder="Email" />
                                                        </div>
                                                        <div className="form-group col-xl-12">
                                                            <label className="me-sm-2">New Password</label>
                                                ...
                                                <form method="post" name="myform" className="personal_validate">
                                                    <div className="form-row">
                                                        <div className="form-group col-xl-6">
                                                            <label className="me-sm-2">Your Name</label>
                                                            <input type="text" className="form-control" placeholder="Maria Pascle" name="fullname" />
                                                        </div>
                                                        <div className="form-group col-xl-6">
                                                        ...
                                                        <div className="form-group col-xl-6">
                                                            <label className="me-sm-2">Present Address</label>
                                                            <input type="text" className="form-control"
                                                                placeholder="56, Old Street, Brooklyn" name="presentaddress" />
                                                        </div>
                                                        <div className="form-group col-xl-6">
                                                            <label className="me-sm-2">Permanent Address</label>
                                                            <input type="text" className="form-control"
                                                        ...
                                                        <div className="form-group col-xl-6">
                                                            <label className="me-sm-2">Country</label>
