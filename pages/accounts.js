                                ...
                                <div className="card profile_card">
                                    <div className="card-body">
                                        <div className="d-flex">
                                            <img className="me-3 rounded-circle me-0 me-sm-3" src="/images/profile/2.png" width="60"
                                                height="60" alt="" />
                                        ...
                                        <div className="social-icons">
                                            <Link className="facebook text-white text-center" href="/"><span><i
                                                className="fa fa-facebook"></i></span></Link >
                                            <Link className="twitter text-white text-center" href="/"><span><i
                                                className="fa fa-twitter"></i></span></Link >
                                            <Link className="youtube text-white text-center" href="/"><span><i
                                                className="fa fa-youtube"></i></span></Link >
                                            <Link className="googlePlus text-white text-center" href="/"><span><i
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        <form>
                                            ...
                                            <button className="btn btn-primary w-100">Withdraw Now</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
